...
while [ $SECONDS -lt $END_TIME ]; do
  ...
  stress-ng --cpu 1 --timeout 15m --log-brief

  log_message "Phase: Idle Period (1 mins)"
  sleep 1m

  log_message "Phase: 4-Core Stress (15 mins)"
  stress-ng --cpu 4 --timeout 15m --log-brief
  ...
  log_message "Phase: GPU Stress (15 mins)"
  stress-ng --gpu 1 --timeout 15m --log-brief
...
log_message "Disabling stability-test service for next boot..."
systemctl disable stability-test && log_message "... succesfully disabled"

log_message "Everything done - Shutting down"
